      ...
      groups: [
        {
          ...
          blocks: [
            ...
            another_address(census_date),
            other_uk_address,
            address_type(census_date),
        ...
        },
        {
          ...
          blocks: [
            country_of_birth(region_code, census_date),
            ...
            ethnic_group_black,
            ethnic_group_other,
            religion(region_code, census_date),
          ] + understandWelshBlock(region_code) + [
            language(region_code),
            speak_english,
            passports,
            health,
            disability(census_date),
            disability_limitation(census_date),
            carer(census_date),
            sexual_identity,
            birth_gender,
          ],
