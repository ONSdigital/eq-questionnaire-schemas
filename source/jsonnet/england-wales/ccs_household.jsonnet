      ...
      groups: [
        {
          ...
          blocks: [
            ...
            confirm_dob,
            sex(census_date),
            country_of_birth(census_date),
            marriage_type(census_date),
            ethnic_group(census_date),
            ethnic_group_white(region_code, census_date),
            ethnic_group_mixed(census_date),
            ethnic_group_asian(census_date),
            ethnic_group_black(census_date),
            ethnic_group_other(census_date),
            in_education(census_date),
            term_time_location,
            past_usual_household_address(census_date),
            length_of_stay(census_date),
            employment_status,
            employment_type,
            another_uk_address,
