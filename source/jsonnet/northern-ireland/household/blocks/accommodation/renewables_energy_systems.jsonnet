...
{
  type: 'Question',
  id: 'renewables-energy-systems',
  question: {
    id: 'renewables-energy-systems-question',
    mandatory: false,
    title: {
    ...
    answers: [
      {
        id: 'renewables-energy-systems-answer',
        mandatory: false,
        type: 'Checkbox',
        options: [
          {
          ...
          },
          {
            ...
            value: 'Other',
            detail_answer: {
              id: 'renewables-energy-systems-answer-other',
              type: 'TextField',
              mandatory: false,
      ...
      {
        id: 'renewables-energy-systems-answer-exclusive',
        type: 'Checkbox',
        mandatory: false,
        options: [
          {
